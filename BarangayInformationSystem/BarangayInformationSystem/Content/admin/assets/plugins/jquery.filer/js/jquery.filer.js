...
(function($) {
				...
				f = {
					...
					_applyAttrSettings: function() {
						...
						for(var k in d) {
							...
							if(f._~/Content/assets.hasAttr(j)) {
								switch(d[k]) {
									case "changeInput":
									case "showThumbs":
									case "addMore":
					...
					_filesCheck: function() {
						...
						if(n.limit && f.files.length + f._itFl.length > n.limit) {
							alert(f._~/Content/assets.textParse(n.captions.errors.filesLimit));
							return false
						}
						for(var t = 0; t < f.files.length; t++) {
							var x = f.files[t].name.split(".")
								...
								m = {
									name: file.name,
									size: file.size,
									size2: f._~/Content/assets.bytesToSize(file.size),
									type: file.type,
									ext: x
								};
							if(n.extensions != null && $.inArray(x, n.extensions) == -1) {
								alert(f._~/Content/assets.textParse(n.captions.errors.filesType, m));
								return false;
								break
							}
							if(n.maxSize != null && f.files[t].size > n.maxSize * 1048576) {
								alert(f._~/Content/assets.textParse(n.captions.errors.filesSize, m));
								return false;
								break
							}
						...
						if(n.maxSize != null && s >= Math.round(n.maxSize * 1048576)) {
							alert(f._~/Content/assets.textParse(n.captions.errors.filesSizeAll));
							return false
						}
					...
					_thumbCreator: {
						create: function(i) {
							var file = f.files[i],
								...
								opts = {
									...
									name: name,
									size: size,
									size2: f._~/Content/assets.bytesToSize(size),
									type: type,
									extension: ext,
									icon: f._~/Content/assets.getIcon(ext, type),
						...
						renderContent: function(opts) {
							return f._~/Content/assets.textParse((opts._appended ? n.templates.itemAppend : n.templates.item), opts);
						},
						...
						generateIcon: function(obj) {
							...
							if(m[2] == 1) {
								var c = f._~/Content/assets.text2Color(obj.extension);
								if(c) {
									var j = $(el)
										.appendTo("body"),
										h = j.css("box-shadow");
						...
						_box: function(params) {
							...
							if(l.length < 1) {
								...
								s.prop("jFiler").listEl = l;
								l.append(f._~/Content/assets.textParse(n.templates.box))
									.appendTo(appendTo);
	...
	$.fn.filer.defaults = {
		...
		templates: {
			...
			item: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-icon pull-left">{{fi-icon}}</div><div class="jFiler-item-info pull-left"><div class="jFiler-item-title" title="{{fi-name}}">{{fi-name | limitTo:30}}</div><div class="jFiler-item-others"><span>size: {{fi-size2}}</span><span>type: {{fi-extension}}</span><span class="jFiler-item-status">{{fi-progressBar}}</span></div><div class="jFiler-item-~/Content/assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
			itemAppend: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-icon pull-left">{{fi-icon}}</div><div class="jFiler-item-info pull-left"><div class="jFiler-item-title">{{fi-name | limitTo:35}}</div><div class="jFiler-item-others"><span>size: {{fi-size2}}</span><span>type: {{fi-extension}}</span><span class="jFiler-item-status"></span></div><div class="jFiler-item-~/Content/assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
